...
public class Search implements ActionListener 
{
	...
	public Search(JFrame frmacc, JLabel lb) 
	{
		...
		frms.setSize(520,372);
		frms.setVisible(true);
		
		pnls=new JPanel(new FlowLayout());
		pnls.setBackground(new Color(0, 102, 255));
		pnls.setForeground(new Color(0, 102, 255));
		frms.getContentPane().add(pnls);
		...
		bts=new JButton("Ok");
		bts.setFont(new Font("Tahoma", Font.BOLD, 11));
		pnls.add(bts);
	...
	private void display() {
		...
		frmsd.getContentPane().add(pnlsd);
